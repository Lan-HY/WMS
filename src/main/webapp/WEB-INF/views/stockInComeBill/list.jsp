            ...
            <div class="ui_text_indent">
                <div id="box_bstockInCome">
                    ...
                    <div id="box_bottom">
                        ...
                        <input type="button" value="新增" data-url="/stockIncomeBill/input.do"
                            ...
                            <td>
                                <c:if test="${entity.status == 0}">
                                    ...
                                    <a href="javascript:" class="btn_delete"
                                       ...
                                       data-reload="/stockIncomeBill/list.do">删除</a>
                                    <a href="javascript:" class="btn_audit"
                                       data-url="/stockIncomeBill/audit.do?id=${entity.id}"
                                       data-reload="/stockIncomeBill/list.do">审核</a>
                                </c:if>
                                <c:if test="${entity.status == 1}">
                                    <a href="/stockIncomeBill/showStockInCome.do?id=${entity.id}">查看</a>
                                </c:if>
                            </td>
                        </tr>
                    </c:forEach>
