			...
			$("#editForm").ajaxForm(function (data) {
				if (data.success) {
				    showDialog("操作成功",function () {
				        //parentId
						location.href = "/systemMenu/list.do?parentId=";
                    });
				} else {
		...
		<div class="ui_content">
			<table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				<tr>
					...
					<td class="ui_text_lt">
						<input readonly value="${parent.name}" class="ui_input_txt02"/>
				...
				<tr>
					<td>&nbsp;</td>
					<td class="ui_text_lt">
						&nbsp;<input type="button" value="确定保存" data-url="/systemMenu/list.do?parentId=${parent.id}" class="ui_input_btn01 btn_submit"/>
