    ...
    <script>
        ...
        $(function () {
            ...
            $("#edit_table_body").on("click", ".searchproduct", function () {
                ...
                $.artDialog.open("/product/searchProduct.do", {
                    ...
                    close : function () {
                        ...
                        if(productInfo) {
                            ...
                            currentTr.find("[tag=amount]").text((productInfo.salePrice * 1).toFixed(2));
                        }
                ...
                currentTr.find("[tag=amount]").text((salePrice * number).toFixed(2));
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" bstockOutcome="0">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <select id="depot.id" name="depot.id" class="ui_select03">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <select id="client.id" name="client.id" class="ui_select03">
                            <c:forEach items="${clients}" var="client">
                                <option value="${client.id}" ${client.id == entity.client.id ? "selected" : ""}>${client.name}</option>
                            </c:forEach>
                        </select>
                    </td>
                </tr>
                        ...
                        <table class="edit_table" cellspacing="0" cellpadding="0" bstockOutcome="0" style="width: auto">
                            ...
                            <c:if test="${entity.id == null}">
                                <tr>
                                    ...
                                    <td><input type="number" tag="salePrice"
                            ...
                            <c:if test="${entity.id != null}">
                                <c:forEach items="${entity.items}" var="item">
                                    <tr>
                                        ...
                                        <td><input type="number" tag="salePrice" value="${item.salePrice}" class="ui_input_txt02"/></td>
